...
/**
 * Checks wheter a guess is the correct word. If correct, deletes the game
 * session.
...
/**
 * Deletes game session and returns 'PASSING_GAME'.
...
module.exports = {
  getRandomShuffledWord: getRandomShuffledWord,
